    ...
    <section className="w-full">
      <div className="relative w-full overflow-hidden aspect-[16/9]">
        ...
        <div className="absolute bottom-0 left-0 z-10 w-full">
          <div className="max-w-2xl px-6 py-8 md:px-12 md:py-12">
            <h2 className="mb-2 h2 font-bold uppercase tracking-widest text-[#FE552C]">
              {active.category}
            </h2>

            <h1 className="mb-4 h1 font-bold leading-snug text-white">
              {active.title}
            </h1>
      ...
      <div className="w-full bg-[#EFEEE7] py-5">
        <div className="px-4 md:px-6 lg:px-8">
          <div
            className="
              no-scrollbar flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory 
            "
          >
            {safeSlides.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`
                    group snap-start flex-shrink-0 overflow-hidden outline-none transition
                    w-[85%]
                    sm:w-[60%]
                    md:w-[45%]
                    lg:w-[calc((100%-32px-80px)/3)]
                    xl:w-[calc((100%-32px-96px)/3)]
                  ...
                  <div className="relative aspect-[16/9] w-full cursor-pointer">
                    ...
                    >
                      <div className="w-full text-center">
                        <div className="h3 font-bold uppercase tracking-widest text-[#FE552C]">
                          {item.category}
                        </div>

                        <div className="mt-0.5 h4 font-medium text-white">
                          {item.tag}
                        </div>
                      </div>
                    </div>
